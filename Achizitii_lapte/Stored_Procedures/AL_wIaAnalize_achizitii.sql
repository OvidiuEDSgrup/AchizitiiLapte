...
BEGIN
    ...
    FROM dbo.AL_Analize_achizitii
		...
		/*JOIN AnotherTable AS At -- (for AL_Analize_achizitii object)*/
	WHERE 1=1 
		/*AND <<logicalExpressionCondition>> -- (for AL_Analize_achizitii object).*/
	FOR XML RAW
