...
BEGIN
    ...
    SELECT
		...
		/*,col1 AS column -- (for AL_Centre_colectare object)*/
    ...
    FROM dbo.AL_Centre_colectare
		...
		/*JOIN AnotherTable AS At -- (for AL_Centre_colectare object)*/
	WHERE 1=1 
		/*AND <<logicalExpressionCondition>> -- (for AL_Centre_colectare object).*/
	FOR XML RAW
