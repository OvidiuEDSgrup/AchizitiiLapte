...
BEGIN
    ...
    SELECT
		...
		/*,col1 AS column -- (for AL_Liste_achizitii object)*/
    ...
    FROM dbo.AL_Liste_achizitii
		...
		/*JOIN AnotherTable AS At -- (for AL_Liste_achizitii object)*/
	WHERE 1=1 
		/*AND <<logicalExpressionCondition>> -- (for AL_Liste_achizitii object).*/
	FOR XML RAW
