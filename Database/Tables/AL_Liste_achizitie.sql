CREATE TABLE dbo.AL_Liste_achizitie (
    id_achizitie_centru INT             
		DEFAULT (NEXT VALUE FOR AL_Liste_achizitie_ID_lista) NOT NULL
		CONSTRAINT PK_AL_Liste_achizitie 
    ...
    tip_plata           CHAR (1)        DEFAULT ('L') NOT NULL
		CONSTRAINT CK_AL_Liste_achizitie_Tip_plata 
...
CREATE UNIQUE NONCLUSTERED INDEX UQ_AL_Lst_achiz_Data_lunii_ID_centru_Tip_lapte
    ON dbo.AL_Liste_achizitie(data_lunii ASC, id_centru ASC, id_tip_lapte ASC);
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'AL_Liste_achizitie',
    @level2type = N'COLUMN',
